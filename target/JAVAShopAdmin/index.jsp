	...
	<section>
		<form action="login_admin" method="post">
			<div class="login">
				...
				<input class="login__email" type="text" placeholder="email / số điện thoại" name="admin_email">
				<input class="login__password" type="password" placeholder="mật khẩu" name="admin_password">
